...
Desktop overlay for VALORANT. Live match data, a few automation tools, and chat.
...
- Chat with friends from the overlay. In-game chat expands shortcuts such as `sa` / `as`, symbols, and `!t` translations. Custom rules live in settings.
